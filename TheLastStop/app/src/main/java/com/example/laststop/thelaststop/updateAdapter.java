...
public class updateAdapter extends BaseAdapter{
    ...
    public updateAdapter(Activity activity, ArrayList<HashMap> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
        {
            convertView = inflater.inflate(R.layout.listaupdate, null);
            holder = new ViewHolder();
            holder.txtFirst = (TextView) convertView.findViewById(R.id.First);
            holder.txtSecond = (TextView) convertView.findViewById(R.id.Second);
            holder.txtThird = (TextView) convertView.findViewById(R.id.Third);
