            ...
            if (request.startsWith("DataRequest:")) {
                ...
                if (temp.startsWith("TimeTable:")) {
                    ...
                    if(serviceType.equals("bus"))
                        ...
                        info = DBConnector.getIstance().executeTimetable(send.query.dbTime(lineStr,stopName,headsign),ritardi);
                        send.toSend(info);
                        send.send();
                ...
                if (temp.startsWith("Stops:")) {
                    ...
                    if(serviceType.equals("bus"))
                        ...
                        send.toSend(info);
                        send.send();
                }//DataRequest:Delay:2:capolinea:fermata:servizi
                 if (temp.startsWith("Delay:")) {
                  ...
                  if (temp.startsWith("SetDelay:")) {
                    ...
                    //2:headsign:Stop:navig:oraA:oraP
                    lineStr = lines[0];//2
                    headsign = lines[1];//headsign
                    stopName = lines[2];//stopname
                    serviceType = lines[3];//servicetype
